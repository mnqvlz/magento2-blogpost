...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Monicavelez_Blog::save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Monicavelez_Blog::post')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Monicavelez\Blog\Model\Post');
