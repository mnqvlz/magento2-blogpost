...
class PostView extends \Magento\Framework\View\Element\Template implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    \Monicavelez\Blog\Model\Post $post,
    \Monicavelez\Blog\Model\PostFactory $postFactory,
    array $data = []
)
{
    ...
    /**
     * @return \Monicavelez\Blog\Model\Post
     */
    public function getPost()
{
    ...
    if (!$this->hasData('post')) {
        if ($this->getPostId()) {
            /** @var \Monicavelez\Blog\Model\Post $page */
...
{
    return [\Monicavelez\Blog\Model\Post::CACHE_TAG . '_' . $this->getPost()->getId()];
}
